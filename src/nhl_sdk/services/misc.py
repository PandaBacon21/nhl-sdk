...
class Misc(CacheFetchMixin):
    ...
    def countries(self) -> list[Country]:
        ...
        return self._fetch(
            "misc:countries",
            lambda: self._client._api.api_stats.call_nhl_sdk_misc.get_countries(),
    ...
    def franchises(self) -> list[Franchise]:
        ...
        return self._fetch(
            "misc:franchises",
            lambda: self._client._api.api_stats.call_nhl_sdk_teams.get_franchise(),
            self._logger, self._cache, self._ttl,
    ...
    def glossary(self) -> list[GlossaryEntry]:
        ...
        return self._fetch(
            "misc:glossary",
            lambda: self._client._api.api_stats.call_nhl_sdk_misc.get_glossary(),
            self._logger, self._cache, self._ttl,
    ...
    def config(self) -> StatsConfig:
        ...
        return self._fetch(
            "misc:config",
            lambda: self._client._api.api_stats.call_nhl_sdk_misc.get_config(),
            self._logger, self._cache, self._ttl,
    ...
    # Use client._api.api_stats.call_nhl_sdk_misc.get_content_module(template_key)
    ...
    def ping(self) -> bool:
        ...
        """
        res = self._client._api.api_stats.call_nhl_sdk_misc.ping()
        return res.ok
