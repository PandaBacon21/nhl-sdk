...
from nhl_sdk.models.players.player.player_stats.reports.skater_summary_report import SkaterSummaryReport
from nhl_sdk.models.players.player.player_stats.reports.goalie_summary_report import GoalieSummaryReport
